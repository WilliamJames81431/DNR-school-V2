      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <div className="flex-shrink-0 flex items-center gap-3">
            <div className="w-12 h-12 bg-brand-orange rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg">
              DNR
            </div>
  ...
  return (
    <section id="home" className="relative h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="https://images.unsplash.com/photo-1523050853064-80453c93a7ad?q=80&w=2070&auto=format&fit=crop" 
          alt="School Campus"
...
const AtalLab = () => {
  ...
  const projects = [
    { title: "Smart Bell System", image: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?q=80&w=2070&auto=format&fit=crop", tag: "Automation" },
    { title: "Rain Detection Project", image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc51?q=80&w=2070&auto=format&fit=crop", tag: "Sensors" },
    { title: "Solar Tracker", image: "https://images.unsplash.com/photo-1509391366360-fe5bb58583bb?q=80&w=2070&auto=format&fit=crop", tag: "Renewable" },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="rounded-3xl overflow-hidden shadow-2xl aspect-video bg-black/20">
            ...
            <iframe 
              ...
              src="https://www.youtube.com/embed?listType=user_uploads&list=dnr-d1n" 
              title="ATL Projects"
              frameBorder="0"
...
const Gallery = () => {
  ...
  const images = [
    { url: "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?q=80&w=2071&auto=format&fit=crop", title: "Annual Day 2025", category: "Events" },
    { url: "https://images.unsplash.com/photo-1509062522246-3755977927d7?q=80&w=2104&auto=format&fit=crop", title: "Science Fair", category: "Activities" },
    { url: "https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=2070&auto=format&fit=crop", title: "Sports Meet", category: "Sports" },
    { url: "https://images.unsplash.com/photo-1511629091441-ee46146481b6?q=80&w=2070&auto=format&fit=crop", title: "Classroom Learning", category: "Academic" },
    { url: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=2022&auto=format&fit=crop", title: "Art Workshop", category: "Activities" },
    { url: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?q=80&w=2073&auto=format&fit=crop", title: "Library Session", category: "Academic" },
    { url: "https://images.unsplash.com/photo-1524178232363-1fb28f74b0cd?q=80&w=2070&auto=format&fit=crop", title: "Cultural Fest", category: "Events" },
    { url: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=2020&auto=format&fit=crop", title: "Yoga Day", category: "Sports" },
    { url: "https://images.unsplash.com/photo-1588072432836-e10032774350?q=80&w=2072&auto=format&fit=crop", title: "School Assembly", category: "Events" },
  ];
